...
export type Database = {
  ...
  public: {
    Tables: {
      activities: {
        Row: {
          ...
          filter_gender: Database["public"]["Enums"]["gender_filter"] | null
          fuzzed_location: unknown
          host_id: string
          id: string
      ...
      activity_members: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "activity_members_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      kept_connections: {
        ...
        Relationships: [
          {
            foreignKeyName: "kept_connections_user_a_fkey"
            columns: ["user_a"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "kept_connections_user_b_fkey"
            columns: ["user_b"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      room_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "room_messages_activity_id_fkey"
            columns: ["activity_id"]
            isOneToOne: false
            referencedRelation: "activities"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      user_gender: "male" | "female" | "non-binary" | "prefer-not-to-say"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
